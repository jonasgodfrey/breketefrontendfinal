...
<!-- Mirrored from uxtheme.net/demos/jobcamp/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Jan 2021 12:34:58 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta http-equiv="X-UA-Compatible" content="ie=edge">
  <title>Brekete Family Complainants | House of Amaya Enterprise</title>
  <link rel="shortcut icon" href="image/ai.png" type="image/x-icon">
        ...
        <nav class="navbar site-navbar offcanvas-active navbar-expand-lg  px-0 py-0">
          ...
          <div class="brand-logo">
            <a href="index-2.html">
              ...
              <img src="image/logo.png" alt="" class="light-version-logo default-logo">
          ...
          <div class="row no-gutters">
            ...
            <div class="col-lg-7 col-md-6">
              <div class="bg-white-2 h-100 px-11 pt-11 pb-7">
                <div class="row">
                  <div class="col-4 col-xs-12">
                    <a href="#" class="font-size-4 font-weight-semibold position-relative text-white bg-allports h-px-48 flex-all-center w-100 px-6 rounded-5 mb-4"><i class="fab fa-linkedin pos-xs-abs-cl font-size-7 ml-xs-4"></i> <span class="d-none d-xs-block">LinkedIn</span></a>
                  </div>
                  <div class="col-4 col-xs-12">
                    <a href="#" class="font-size-4 font-weight-semibold position-relative text-white bg-poppy h-px-48 flex-all-center w-100 px-6 rounded-5 mb-4"><i class="fab fa-google pos-xs-abs-cl font-size-7 ml-xs-4"></i> <span class="d-none d-xs-block">Google</span></a>
                  </div>
                  <div class="col-4 col-xs-12">
                    <a href="#" class="font-size-4 font-weight-semibold position-relative text-white bg-marino h-px-48 flex-all-center w-100 px-6 rounded-5 mb-4"><i class="fab fa-facebook-square pos-xs-abs-cl font-size-7 ml-xs-4"></i> <span class="d-none d-xs-block">Facebook</span></a>
                  </div>
                </div>
                <div class="or-devider">
                  <span class="font-size-3 line-height-reset">Or</span>
                ...
                <form action="#">
                  ...
                  <p class="font-size-4 text-center heading-default-color">Have an account? <a href="#" class="text-primary">Sign in Here</a></p>
                </form>
              </div>
            </div>
          </div>
        ...
        <div class="row position-relative align-items-center">
          ...
          <div class="col-lg-6 col-md-4 col-sm-6 col-xs-6 col-8 pos-abs-br z-index-n1 position-static position-md-absolute mx-auto ml-md-auto" data-aos="fade-left" data-aos-duration="800" data-aos-once="true">
            <div class=" ml-xxl-23 ml-xl-12 ml-md-7">
              <img src="image/ai.png" alt="" class="w-100">
            </div>
          </div>
          <!-- ./Hero Right Image -->
        </div>
        ...
        <div class="row align-items-center pb-14">
          ...
          <div class="col-12 col-lg-6">
            <div class="text-center text-lg-left mb-13 mb-lg-0">
              <h2 class="font-size-9 font-weight-bold">How It Works</h2>
            </div>
          </div>
          <!-- Section Button -->
          <!-- <div class="col-12 col-lg-6">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
            <a href="#" class="bg-white border border-color-2 rounded-4 pl-9 pt-10 pb-3 pr-7 hover-shadow-1 mb-9 d-block w-100">
              <div class="text-blue bg-blue-opacity-1 square-70 rounded-4 mb-7 font-size-7">
                <i <i class="far fa-newspaper"></i>
              </div>
              <!-- Category Content -->
              <div class="">
                <h5 class="font-size-5 font-weight-semibold text-black-2 line-height-1">Submit Complaint</h5>
          ...
          <div class="col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
            <a href="#" class="bg-white border border-color-2 rounded-4 pl-9 pt-10 pb-3 pr-7 hover-shadow-1 mb-9 d-block w-100">
              ...
              <!-- Category Content -->
              <div class="">
                <h5 class="font-size-5 font-weight-semibold text-black-2 line-height-1">Wait For Review/Feedback</h5>
                <!-- <p class="font-size-4 font-weight-normal text-gray"><span>415</span> Vacancy</p> -->
              </div>
            </a>
          </div>
          ...
          <div class="col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
            <a href="#" class="bg-white border border-color-2 rounded-4 pl-9 pt-10 pb-3 pr-7 hover-shadow-1 mb-9 d-block w-100">
              ...
              <!-- Category Content -->
              <div class="">
                <h5 class="font-size-5 font-weight-semibold text-black-2 line-height-1">Track Progress</h5>
                <!-- <p class="font-size-4 font-weight-normal text-gray"><span>415</span> Vacancy</p> -->
              </div>
            </a>
          </div>
          ...
          <div class="col-12 col-xl-3 col-lg-4 col-sm-6 col-xs-8">
            <a href="#" class="bg-white border border-color-2 rounded-4 pl-9 pt-10 pb-3 pr-7 hover-shadow-1 mb-9 d-block w-100">
              ...
              <!-- Category Content -->
              <div class="">
                <h5 class="font-size-5 font-weight-semibold text-black-2 line-height-1">Submit Testimonials</h5>
                <!-- <p class="font-size-4 font-weight-normal text-gray"><span>415</span> Vacancy</p> -->
              </div>
            </a>
          </div>
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-11" data-aos="fade-right" data-aos-duration="800" data-aos-once="true">
            <!-- content-1 left-content start -->
              ...
              <br>
                ...
                <br><br>
                <div class="row">
                  <button type="submit" name="submit" id="butt" class="btn btn-lg btn-success">Submit Complaint</button>
      ...
      <div class="container">
        ...
        <div class="row align-items-center pb-14">
          ...
          <div class="col-12 col-xl-6 col-lg-6">
            <div class="text-center text-lg-left mb-13 mb-lg-0">
              <h2 class="font-size-9 font-weight-bold">Testimonials</h2>
            </div>
          </div>
          <!-- Section Button -->
          <!-- <div class="col-12 col-xl-6 col-lg-6">
          ...
          <div class="col-lg-6 col-md-9 col-xs-10" data-aos="fade-left" data-aos-duration="800" data-aos-once="true">
            ...
            <div class="content-2 pl-lg-10 pl-0 d-flex flex-column justify-content-center h-100 pt-lg-0 pt-11 pr-md-13 pr-xl-15 pr-xxl-25 pr-0">
              ...
              <p class="text-dodger font-size-4 font-weight-semibold mb-8">
                Want to Know More Brekete Family Complaint System?
              </p>
          ...
          <div class="row justify-content-center ">
            <div class="col-xl-7 col-lg-12" data-aos="fade-right" data-aos-duration="800" data-aos-once="true">
              ...
              <div class="pb-xl-0 pb-9 text-xl-left text-center">
                <h2 class="text-white font-size-8 mb-4">Want to Sign Up?</h2>
                <p class="text-hit-gray font-size-5 mb-0">Click the Link below</p>
              </div>
              <!-- cta-content end -->
            </div>
...
<!-- Mirrored from uxtheme.net/demos/jobcamp/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Jan 2021 12:35:17 GMT -->
</html>
